        ...
        */
        ...
        __checkPosition: function () {
            ...
            if (this.directionX > 0) {
                ...
                this.currentMasterPage = (this.page + 1) - Math.floor((this.page + 1) / this.options.numberOfPages) * this.options.numberOfPages;
                this.pageIndex = this.pageIndex === 0 ? this.options.numberOfPages - 1 : this.pageIndex - 1;

                pageFlip = this.currentMasterPage - 1;
                pageFlip = pageFlip < 0 ? this.options.numberOfPages - 1 : pageFlip;
                ...
                pageFlip = this.currentMasterPage + 1;
                pageFlip = pageFlip > this.options.numberOfPages - 1 ? 0 : pageFlip;
                this.masterPages[pageFlip].style.left = this.page * 100 + 100 + '%';
        ...
        __flip: function () {
            ...
            for (var i = 0; i < this.options.numberOfPages; i++) {
